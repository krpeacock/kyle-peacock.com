...
This is an outline for a talk I (will/have) presented at ASPLOS 2022 on the full picture of how dapps are built on the Internet Computer. It's not fully fleshed out, since I'll be using it to make slides, but I figured I'd publish it anyway in case it is helpful to anyone.
