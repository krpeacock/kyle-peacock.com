...
<h2 id="fund-update">Update - how to fund your first canister</h2>

We now have [a guide](https://sdk.dfinity.org/docs/quickstart/network-quickstart.html) on how to pay for and set up your first canister. The basic flow (for now) basically looks like:
