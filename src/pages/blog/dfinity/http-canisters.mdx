...
We provide you with the basics of how to get started with the new `dfx new` template. Check out the [forum post](https://forum.dfinity.org/t/preview-improved-asset-canisters/2387) for some more details about downloading and getting set up with the preview build of DFX.
