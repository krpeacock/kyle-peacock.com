...
You can find reference code for this next step at https://github.com/krpeacock/motoko_unit_testing. There, you will find examples of a `makefile`, the `vessel.dhall` and `package-set.dhall` files that you will need to get your test suite running.
