...
Since we can also pass new line characters, I can no predictably write to all the available spaces using two 16 character strings joined by a `\n` newline character.
